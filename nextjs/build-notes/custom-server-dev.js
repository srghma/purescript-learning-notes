      ...
      },
      {
        oneOf: [
          ...
          },
          {
            ...
            use: [
              {
                loader: '/home/srghma/projects/next.js/examples/custom-server/node_modules/style-loader/dist/index.js',
  ...
  plugins: [
    ...
    DefinePlugin {
      definitions: {
        ...
        'process.env.__NEXT_DIST_DIR': '"/home/srghma/projects/next.js/examples/custom-server/.next"',
